...
class JFormFieldDuration extends JFormField
{
    ...
    protected function getInput()
    {
        ...
        $options = [];
        $options[] = JHTML::_('select.option', 'D', vmText::_('VMPAYMENT_nextpay_DURATION_D'));
        $options[] = JHTML::_('select.option', 'W', vmText::_('VMPAYMENT_nextpay_DURATION_W'));
        $options[] = JHTML::_('select.option', 'M', vmText::_('VMPAYMENT_nextpay_DURATION_M'));
        $options[] = JHTML::_('select.option', 'Y', vmText::_('VMPAYMENT_nextpay_DURATION_Y'));
