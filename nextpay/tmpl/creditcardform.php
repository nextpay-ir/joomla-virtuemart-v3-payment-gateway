...
vmJsApi::addJScript('/plugins/vmpayment/nextpay/nextpay/assets/js/site.js');
...
<div id="paymentMethodOptions_<?php echo $viewData['virtuemart_paymentmethod_id']; ?>" class="paymentMethodOptions" >
    ...
    <span class="vmpayment_cardinfo">
        <?php 
       echo vmText::_('VMPAYMENT_nextpay_CC_COMPLETE_FORM');
        if ($viewData['sandbox']) {
            echo '<br />'.vmText::_('VMPAYMENT_nextpay_CC_SANDBOX_INFO');
        }
        ?>
        <table border="0" cellspacing="0" cellpadding="2" width="100%">
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="creditcardtype"><?php echo vmText::_('VMPAYMENT_nextpay_CC_CCTYPE'); ?></label>
                </td>
                <td>
                	...
                	<ul class="cards">
                        ...
                        foreach ($viewData['creditcards'] as $creditCard) {
                            echo '<li class="'.$creditCard.'">'.vmText::_('VMPAYMENT_nextpay_CC_'.strtoupper($creditCard)).'</li>';
                            //$options[] = JHTML::_('select.option', $creditCard, vmText::_('VMPAYMENT_nextpay_CC_' . strtoupper($creditCard)));
                        }
                        ?>                    	
                    </ul>
                    <?php
            ...
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="cc_type"><?php echo vmText::_('VMPAYMENT_nextpay_CC_CCNUM'); ?></label>
                </td>
                <td>
            ...
            <tr valign="top">
                <td nowrap width="10%" align="right">
                    <label for="cc_cvv"><?php echo vmText::_('VMPAYMENT_nextpay_CC_CVV2') ?></label>
                </td>
                <td>
                    ...
                    <span class="hasTip" title="<?php echo vmText::_('VMPAYMENT_nextpay_CC_WHATISCVV') ?>::<?php echo vmText::sprintf('VMPAYMENT_nextpay_CC_WHATISCVV_TOOLTIP', $this->_displayCVVImages($viewData['method'])) ?> ">
                        <?php echo vmText::_('VMPAYMENT_nextpay_CC_WHATISCVV'); ?>
                    </span>
                </td>
            </tr>
            <tr>
                <td nowrap width="10%" align="right"><?php echo vmText::_('VMPAYMENT_nextpay_CC_EXDATE'); ?></td>
                <td>
                    <?php 
