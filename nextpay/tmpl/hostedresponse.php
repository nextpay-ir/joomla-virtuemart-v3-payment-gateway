...
<table>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_nextpay_API_PAYMENT_NAME'); ?></td>
	...
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_nextpay_API_AMOUNT'); ?></td>
        <td><?php echo $payment->mc_gross.' '.$payment->mc_currency; ?></td>
    </tr>
	<?php if ($success) {
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_nextpay_API_TRANSACTION_ID');
    ?></td>
        <!--td><?php echo $payment->nextpay_response_trx_id;
    ?></td -->
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_nextpay_API_ERROR_CODE');
    ?></td>
    ...
    ?>
	<tr>
    	<td><?php echo vmText::_('VMPAYMENT_nextpay_API_ERROR_DESC');
    ?></td>
